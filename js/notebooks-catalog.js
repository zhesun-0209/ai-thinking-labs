  ...
  8: {
    ...
    items: [
      ...
      },
      {
        ...
        blurb: "国家到首都的向量平移，加上句子注意力权重热力图。",
        outcomes: ["计算 TransE 距离", "观察查询词如何分配注意力"],
        result: "距离表、几何图、注意力权重、最高关注标注",
        tier: "B",
        minutes: 22,
        ready: true,
      },
  ...
  9: {
    ...
    items: [
      ...
      },
      {
        ...
        outcomes: ["读懂因果遮罩", "连接注意力和下一词预测"],
        result: "注意力矩阵、二元词概率、预测表",
        tier: "B",
        minutes: 20,
        ready: true,
      },
  ...
  10: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "真实照片 MAE 掩码重建",
        blurb: "在同一张真实照片上遮住 75% 图块，观察 MAE 的可见输入和重建目标。",
        outcomes: ["观察随机遮挡", "理解重建目标"],
        result: "原图、遮挡图、可见图块、重建基线",
        tier: "B",
        minutes: 15,
        ready: true,
      },
  ...
  11: {
    ...
    items: [
      ...
      },
      {
        ...
        blurb: "先渲染出租车初始状态，再观察一次动作如何更新 Q 表以及回报如何变化。",
        outcomes: ["读懂状态和动作", "观察 Q-learning 更新"],
        result: "初始状态、动作表、TD 样本、Q 值前后变化、回报曲线、环境渲染",
        tier: "A",
        minutes: 12,
        scope: "extension",
        ready: true,
      },
      {
        ...
        title: "悬崖行走探索策略",
        blurb: "先看悬崖地图和探索式选择，再比较不同探索强度下的路线。",
        outcomes: ["区分随机探索和当前最优选择", "观察训练后路径"],
        result: "悬崖地图、探索解释、贪心路径、训练回报、探索率对比、策略图",
        tier: "A",
        minutes: 10,
        ready: true,
      },
  ...
  12: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "真实图片扩散去噪",
        blurb: "用真实花朵照片展示从清晰图像到噪声图像，再到图块去噪结果的变化。",
      ...
      },
      {
        ...
        title: "真实图片图块 GAN",
        blurb: "在真实花朵照片图块上训练生成器和判别器，观察生成纹理如何接近真实局部图像。",
        outcomes: ["观察生成器与判别器损失", "查看生成图块"],
        result: "训练曲线、真实图块、生成图块、判别器评分",
        tier: "C",
        minutes: 25,
        ready: true,
      },
      ...
      },
      {
        ...
        title: "蛋白序列位置对表征",
        blurb: "用胰岛素 A 链片段的多序列对齐，先看序列如何对齐，再展示保守性与位置对表征。",
        outcomes: ["读懂 MSA 表", "理解位置对表征从哪里来"],
        result: "MSA 表、保守性计算、位置对示例、位置保守性图、位置对表征热力图",
        tier: "D",
        minutes: 10,
        scope: "extension",
        ready: true,
